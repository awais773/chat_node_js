        ...
        if (datastring.charAt(0) == "{") {
            ...
            if (boardws) {
                ...
                const message = {
                    ...
                    token: 'eu6iZE6VR4KQawZi79B_Yr:APA91bFg85Aa2XC4h3KCDsdjTu6DQ5bXs_ifkeDZwFybS3HS5dufupqxIrt4srCqfM4xsjMd1YphBXGu61G3DHS8_-sm13Y8X4P4E0H2l7gC1sT8oA79_-aGr0h2_IZRmjT5MqBNzVKM',
                    data: {
                        id: data.id,
                        text: data.text,
