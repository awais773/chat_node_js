        ...
        if (datastring.charAt(0) == "{") {
            ...
            if (boardws) {
                ...
                const message = {
                    ...
                    token: 'cH9f1F5kR3GmRjb373WKJo:APA91bFMwpzLQmWULhH12PoQ--T7QALugyniHcaZ640uGXiNXgxaJZjidKDARhvtsb_1ptQ2j9_SK2Y-D0kafPSptEjgMDANAQ2VGtZ48cx_t1BP4IIzfocH7cJGYYb3B4L6gbDUsMKH',
                    data: {
                        id: data.id,
                        text: data.text,
